""" 
Alternative implementation of the single function as my own one still has error 
Adopted from in class solution and credit goes to the course instructor
Link: https://github.com/taobrienlbl/advanced_earth_science_data_analysis/tree/spring_2023_iub/lessons/09_parallelization_intro/in_class_solutions 
"""
